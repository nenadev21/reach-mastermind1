...
export function compareGuessVsRandom1(guesses, random) {
  //check for duplicates
  let perfectMatch = []; //match in number and location
  let equalValues = []; // counts numbers that are similar btw the two arrays. Detects repeated numbers. It counts perfect matches.
...
// export function compareGuessVsRandom2(guesses, random) {
//   //check for duplicates
//   let perfectMatch = []; //match in number and location
//   let equalValues = []; // counts numbers that are similar btw the two arrays. Detects repeated numbers. It counts perfect matches.
//   for (let i = 0; i < guesses.length; i++) {
...
//     }
//   }
//   equalValues = countCommonValuesOfArrays(guesses, random);
//   return {
//     gameMatch: perfectMatch === random.length,
//     perfectMatch: perfectMatch,
//     equalValues: equalValues,
...
// console.log(compareGuessVsRandom2(guesses1, rand));
// console.log(compareGuessVsRandom2(guesses2, rand));
// console.log(compareGuessVsRandom2(guesses3, rand));
// console.log(compareGuessVsRandom2(guesses4, rand));
